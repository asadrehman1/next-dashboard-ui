            ...
            <td>
                <div className="flex items-center gap-2">
                    <Link href={`/list/teachers/${item.id}`}>
                        <button className="w-7 h-7 flex items-center justify-center rounded-full bg-asadSky">
                            <Image src="/edit.png" alt="view icon" width={16} height={16} />
                        </button>
                    </Link>
                    {role === "admin" &&
                        <button className="w-7 h-7 flex items-center justify-center rounded-full bg-asadPurple">
                            <Image src="/delete.png" alt="view icon" width={16} height={16} />
                        </button>
                    }
                </div>
            </td>
