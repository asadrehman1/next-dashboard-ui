        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray 500">
                    <Link href="/" className="p-3 rounded-md bg-asadSkyLite">Teacher&apos;s Classes</Link>
                    <Link href="/" className="p-3 rounded-md bg-asadPurpleLite">Teacher&apos;s Students</Link>
                    <Link href="/" className="p-3 rounded-md bg-asadYellowLite">Teacher&apos;s Lessons</Link>
